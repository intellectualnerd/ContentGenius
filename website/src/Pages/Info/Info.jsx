...
const Info = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    Cookies.remove("userIdContent");
    Cookies.remove("idTokenContent");
    if (Cookies.get('userIdContent') && Cookies.get('idTokenContent')) {
            ...
            try {
                ...
                Cookies.set('userIdContent', userInfo, { expires: 100000 });
                Cookies.set('idTokenContent', idToken, { expires: 100000 });
